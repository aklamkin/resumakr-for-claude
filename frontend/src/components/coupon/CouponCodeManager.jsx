...
export default function CouponCodeManager({ showNotification }) {
  ...
  const createMutation = useMutation({
    mutationFn: (data) => api.entities.CouponCode.create(data),
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }) => api.entities.CouponCode.update(id, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["coupon-codes"] });
      resetForm();
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => api.entities.CouponCode.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["coupon-codes"] });
