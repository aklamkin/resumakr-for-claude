    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950 p-6">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-4xl font-bold text-slate-900 dark:text-slate-100 mb-2">Subscription Plans</h1>
          <p className="text-slate-600 dark:text-slate-400">Manage pricing plans for your application</p>
        </motion.div>

        <SubscriptionPlanManager showNotification={showNotification} />
      </div>
